...
namespace GeneratedWrappers.Acumatica
{
    ...
    public class SM204505_ProjectList : Wrapper
    {
        ...
        public virtual void ActionPublishMenu()
        {
            ToolBar.ActionPublishMenu.Click();
        }
        ...
        public virtual void ActionImportMenu()
        {
            ToolBar.ActionImportMenu.Click();
        }

        public virtual void ActionImportNew()
        {
            ToolBar.ActionImportNew.Click();
        }
        ...
        public virtual void ActionImportNewHidden()
        {
            ToolBar.ActionImportNewHidden.Click();
        }

        public virtual void ActionImportReplaceHidden()
        {
            ToolBar.ActionImportReplaceHidden.Click();
        }
        ...
        public virtual void ActionPublishExtHidden()
        {
            ToolBar.ActionPublishExtHidden.Click();
        }

        public virtual void Validations()
        {
            ToolBar.Validations.Click();
        }
        ...
        public virtual void ActionValidateHighlightedHidden()
        {
            ToolBar.ActionValidateHighlightedHidden.Click();
        }

        public virtual void ActionValidateMultipleHidden()
        {
            ToolBar.ActionValidateMultipleHidden.Click();
        }

        public virtual void ActionRuntimeValidationDACFieldsTypesHidden()
        {
            ToolBar.ActionRuntimeValidationDACFieldsTypesHidden.Click();
        }

        public virtual void ActionRuntimeValidationDACAttributesHidden()
        {
            ToolBar.ActionRuntimeValidationDACAttributesHidden.Click();
        }

        public virtual void ActionRuntimeValidationLookupsDefinitionsHidden()
        {
            ToolBar.ActionRuntimeValidationLookupsDefinitionsHidden.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
            ...
            public ToolBarButton ActionPublishMenu { get; }
            ...
            public ToolBarButton ActionImportMenu { get; }
            public ToolBarButton ActionImportNew { get; }
            public ToolBarButton ActionImportReplace { get; }
            public ToolBarButton ActionImport { get; }
            public ToolBarButton ActionImportNewHidden { get; }
            public ToolBarButton ActionImportReplaceHidden { get; }
            public ToolBarButton ActionSavePackage { get; }
            public ToolBarButton ActionPublishedXml { get; }
            public ToolBarButton ActionPublishExtHidden { get; }
            public ToolBarButton Validations { get; }
            ...
            public ToolBarButton ActionValidateHighlightedHidden { get; }
            public ToolBarButton ActionValidateMultipleHidden { get; }
            public ToolBarButton ActionRuntimeValidationDACFieldsTypesHidden { get; }
            public ToolBarButton ActionRuntimeValidationDACAttributesHidden { get; }
            public ToolBarButton ActionRuntimeValidationLookupsDefinitionsHidden { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                Favorites = new ToolBarButton("css=#ctl00_usrCaption_tlbPath div[data-cmd=\'favorites\']", "Remove from Favorites", locator, null);
                ...
                ActionPublishMenu = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div:textEqual(\"Publish\") > div[data-type=\'drop\']", "Publish the selected projects, unpublish the not selected projects.", locator, null);
                ActionPublishExt = new ToolBarButton("css=li[data-cmd=\'actionPublish@actionPublishExt\']", "Publish to Multiple Tenants", locator, ActionPublishMenu);
                ActionPublish = new ToolBarButton("css=div[data-cmd=\'actionPublish\']", "Publish the selected projects, unpublish the not selected projects.", locator, null);
                ActionUndoPublish = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionUndoPublish\']", "Remove all published customizations from the website.", locator, null);
                ActionImportMenu = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div:textEqual(\"Import\") > div[data-type=\'drop\']", "Import", locator, null);
                ActionImportNew = new ToolBarButton("css=li[data-cmd=\'actionImport@actionImportNew\']", "Import New Project", locator, ActionImportMenu);
                ActionImportReplace = new ToolBarButton("css=li[data-cmd=\'actionImport@actionImportReplace\']", "Replace Highlighted Project Content", locator, ActionImportMenu);
                ActionImport = new ToolBarButton("css=div[data-cmd=\'actionImport\']", "Import", locator, null);
                ActionImportNewHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionImportNew\']", "Import New Project", locator, null);
                ActionImportReplaceHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionImportReplace\']", "Replace Highlighted Project Content", locator, null);
                ActionSavePackage = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionSavePackage\']", "Export the project to a file.", locator, null);
                ActionPublishedXml = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionPublishedXml\']", "View XML of the published customization.", locator, null);
                ActionPublishExtHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionPublishExt\']", "Publish to Multiple Tenants", locator, null);
                Validations = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div:textEqual(\"Validations\") > div[data-type=\'drop\']", "Validations", locator, null);
                ActionValidateHighlighted = new ToolBarButton("css=li[data-cmd=\'actionValidations@actionValidateHighlighted\']", "Validate Highlighted Project", locator, Validations);
                ActionValidateMultiple = new ToolBarButton("css=li[data-cmd=\'actionValidations@actionValidateMultiple\']", "Validate Multiple Projects", locator, Validations);
                ActionRuntimeValidationDACFieldsTypes = new ToolBarButton("css=li[data-cmd=\'actionValidations@actionRuntimeValidationDACFieldsTypes\']", "DAC Field Types (Runtime Validation)", locator, Validations);
                ActionRuntimeValidationDACAttributes = new ToolBarButton("css=li[data-cmd=\'actionValidations@actionRuntimeValidationDACAttributes\']", "DAC Attributes (Runtime Validation)", locator, Validations);
                ActionRuntimeValidationLookupsDefinitions = new ToolBarButton("css=li[data-cmd=\'actionValidations@actionRuntimeValidationLookupsDefinitions\']", "Lookup Definitions (Runtime Validation)", locator, Validations);
                ActionValidateHighlightedHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionValidateHighlighted\']", "Validate Highlighted Project", locator, null);
                ActionValidateMultipleHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionValidateMultiple\']", "Validate Multiple Projects", locator, null);
                ActionRuntimeValidationDACFieldsTypesHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionRuntimeValidationDACFieldsTypes\']", "DAC Field Types (Runtime Validation)", locator, null);
                ActionRuntimeValidationDACAttributesHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionRuntimeValidationDACAttributes\']", "DAC Attributes (Runtime Validation)", locator, null);
                ActionRuntimeValidationLookupsDefinitionsHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'actionRuntimeValidationLookupsDefinition" +
                        "s\']", "Lookup Definitions (Runtime Validation)", locator, null);
        ...
        public class c_viewpublishoptions_viewpublishoptions : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                DisableOptimization = new CheckBox("ctl00_phL_PanelPublishExt_ViewPublishOptions_DisableOptimization", "Execute All Database Scrips (Including Previously Executed)", locator, null);
